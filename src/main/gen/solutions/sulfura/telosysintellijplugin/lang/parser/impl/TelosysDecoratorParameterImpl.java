...
public class TelosysDecoratorParameterImpl extends ASTWrapperPsiElement implements TelosysDecoratorParameter {

  public TelosysDecoratorParameterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TelosysVisitor visitor) {
    visitor.visitDecoratorParameter(this);
  }
